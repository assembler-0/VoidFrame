...
#define EEVDF_PROC_PRIV_SYSTEM     0
#define EEVDF_PROC_PRIV_NORM       1
#define EEVDF_PROC_PRIV_RESTRICTED 2

// Security flags (same as MLFQ)
#define EEVDF_PROC_FLAG_NONE          0U
#define EEVDF_PROC_FLAG_IMMUNE        (1U << 0)
#define EEVDF_PROC_FLAG_CRITICAL      (1U << 1)
#define EEVDF_PROC_FLAG_SUPERVISOR    (1U << 3)
